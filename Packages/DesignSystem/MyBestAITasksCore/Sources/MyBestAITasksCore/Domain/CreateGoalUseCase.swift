...
public struct CreateGoalUseCase {
    ...
    init(repository: GoalRepositoryProtocol, geminiService: GeminiService, notificationManager: NotificationManaging) {
    ...
    func execute(title: String, deadline: Date) async throws {
        // 1. Geminiでタスク生成
